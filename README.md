...
This is a customized version of Taichi MPM written by [Yuanming Hu (MIT CSAIL)](http://taichi.graphics/me/) for modeling granular flows with the Nonlocal Granular Fluidity constitutive model developed by [Dr. Ken Kamrin (MIT)](http://web.mit.edu/kkamrin/www/fluid_solid.html).
