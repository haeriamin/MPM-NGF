...
This is a modified version of Taichi MPM written by [Y. Hu (MIT)](https://yuanming.taichi.graphics) for modeling granular flows (via the Nonlocal Granular Fluidity constitutive model) and their interactions with rigid bodies.
